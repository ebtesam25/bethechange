...
console.log(responseJson);
  ...
  render(){
    ...
    <View style={styles.container}>
      ...
      <Text style={{position:'relative',fontSize:20,margin:'auto', textAlign:'center', color:'#FFF', fontFamily:'FuturaH', marginTop:'15%', backgroundColor:'#B24C32', padding:'5%', width:'70%', borderRadius:10, alignSelf:'center', elevation:1}} onPress={()=>{this.registerUser();this.props.navigation.navigate('Login');}}>REGISTER</Text>
