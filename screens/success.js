...
export default function Success({ route}) {
    ...
    <View style={styles.container}>
         ...
         <Text style={styles.thanks}>Congratulations!</Text>
         <Text style={styles.description}>Your fundraiser is now live. We will notify you when you receive a donation from a generous user</Text>
        
        <View style={{backgroundColor:'#195F56', paddingVertical:'10%', marginTop:'10%'}}>
         <Text style={styles.name}><Text style={{fontFamily:'FuturaL'}}> You created</Text> {title}</Text>
